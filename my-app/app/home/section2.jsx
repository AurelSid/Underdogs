  ...
  return (
    <div className=" lg:h-screen h-full flex bg-cover bg-center">
      ...
      <div
        id="section2"
        ref={section2Ref}
        className=" w-full h-full justify-center items-center md:py-20 md:py-none md:mt-20 lg:mt-0 px-10 md:px-0  lg:flex lg:z-20  bg-black md:bg-opacity-0 md:bg-none"
      >
        <div className="flex justify-center items-center  h-full w-full ">
          <div className=" justify-center items-center text-white bg-none md:bg-black md:bg-opacity-70 w-screen pt-10 md:py-10">
            <h1 className="lg:text-5xl text-lg font-bold  w-full   justify-center items-center m-auto text-center ">
